...
public interface Player {
  ...
  /**
   * @param coinPair <pre>a CoinPair containing final coin values (updated from the GameEngine
   *                            {@link GameEngine#spinPlayer(Player, int, int, int, int, int, int)})</pre>
   */
  public abstract void setResult(CoinPair coinPair);
  
  /**
   * @return <pre>a human readable String that lists the values of this Player
